...
const App = () => {
  ...
  const handleAvailDiscount = useCallback(async (offer) => {
    ...
    // 1. Check if the code has already been claimed for this offer
    ...
    if (!snapshot.empty) {
      ...
      try {
        ...
        // **NEW LOGIC:** Increment totalClaims only for NEW claims
        await updateDoc(offerRef, {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        ...
        <section id="offers" className="pb-12">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-3xl font-bold text-gray-800 border-l-4 border-orange-500 pl-3">
      ...
      {/* Partner Dashboard Rendered Here */}
      {dashboardOpen && (
        <PartnerDashboard
          offers={offers}
